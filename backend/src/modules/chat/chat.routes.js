...
router.post("/ai/search-products/click", verifyToken, ChatController.trackSearchClick);
router.get("/ai/search-metrics", verifyToken, verifyAdmin, ChatController.getSearchMetrics);
router.post(
