...
const MESSAGES = {
  ...
  AUTH: {
    ...
    ACCOUNT_BANNED: "Tài khoản đã bị khóa bởi quản trị viên",
  ...
  PRODUCT: {
    ...
    DELETE_HAS_ORDERS: "Không thể xóa sản phẩm đang có trong đơn hàng. Vui lòng đợi đơn hoàn tất hoặc hủy.",
